...
>In case you are experiencing connectivity issues, on the app you can try using different star node configurations in Settings > IPFS. The web demo unfortunately intermittently breaks because it doesn't have that feature yet. Check 

```json
# https://github.com/QuestNetwork/qDesk/blob/0.9.4/src/app/swarm.json
```
...
Download our example application on your favorite operating systems:
